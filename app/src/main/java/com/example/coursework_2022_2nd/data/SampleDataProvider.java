...
//        apartments.add(new ApartmentEntity("4", "house", "Salut", "Hello", 4, "Hello", "Hello", "Hello"));
        trips.add(new ExpenseEntity("1", "2", "Hello","Hello", 2, "Hello"));
        trips.add(new ExpenseEntity("2", "2", "Hello","Hello", 2, "Hello"));
        trips.add(new ExpenseEntity("3", "2", "Hello","Hello", 2, "Hello"));
        return trips;
    }
}
